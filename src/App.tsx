  ...
  const steps = [
    {
      ...
      description: 'We start with a quick discovery call to understand your services, goals, and target audience.'
    },
    {
      number: '02',
      title: 'We build your AI-powered site',
      description: 'Our team designs and develops your custom website and integrates intelligent lead capture tools.'
    },
    {
      number: '03',
      title: 'You get more leads & customers',
      description: 'Launch your new site and watch as our AI automation turns more visitors into booked appointments.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            Getting a high-converting website shouldn't be complicated. We handle the tech, you handle the new business.
          </p>
        </div>
...
const WhyChooseUs = () => {
  const reasons = [
    ...
    },
    {
      ...
      description: 'Get your professional, high-end website live in weeks, not months, without sacrificing quality.',
      icon: <CheckCircle2 className="w-6 h-6" />
    },
    {
      title: 'Tailored for Local Business',
      description: 'We understand the unique needs of service providers like plumbers, HVAC, and landscapers.',
