...
```bash
python3 prompts/ui-ux-pro-max/scripts/search.py "<keyword>" --stack react-native
```
...
```bash
python3 prompts/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack react-native
```
